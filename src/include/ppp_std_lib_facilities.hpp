#ifndef CPP_PRACTICE_SRC_INCLUDE_PPP_STD_LIB_FACILITIES_HPP_
#define CPP_PRACTICE_SRC_INCLUDE_PPP_STD_LIB_FACILITIES_HPP_
...
#endif //CPP_PRACTICE_SRC_INCLUDE_PPP_STD_LIB_FACILITIES_HPP_
